...
export const metadata: Metadata = {
  title: `${pagesConfig.home.metadata.title} | Fernando Camilotti's Portfolio`,
...
export default function IndexPage() {
  ...
  const softwareSchema = {
    ...
    name: "Fernando Camilotti's Portfolio",
      ...
      <section className="space-y-6 pb-8 pt-6 mb-0 md:pb-12 md:py-20 lg:py-32 h-screen flex items-center">
        <div className="container flex max-w-[64rem] flex-col items-center gap-4 text-center -mt-20">
          <Image
            ...
            alt="Fernando Camilotti - Full Stack Software Engineer Portfolio"
            priority
          />
          <AnimatedText
            as="h1"
          ...
          <div className="flex flex-col mt-10 items-center justify-center sm:flex-row sm:space-x-4 gap-3">
            <AnimatedText delay={0.6}>
              <Link
                href={
                  "https://www.linkedin.com/in/fernandocamilotti/?locale=en_US"
                }
                target="_blank"
                className={cn(buttonVariants({ size: "lg" }))}
                aria-label="View Fernando Camilotti's LinkedIn profile"
              >
            ...
            <AnimatedText delay={0.8}>
              <Link
                ...
                aria-label="Contact Fernando Camilotti"
              >
