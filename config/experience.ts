...
export const experiences: ExperienceInterface[] = [
  ...
  {
    id: "fight-analytics",
    position: "Chief of Design Office and Founder",
    company: "Fight Analytics",
    location: "Porto Alegre, Brazil",
    startDate: new Date("2014-08-01"),
    endDate: new Date("2016-01-01"),
    description: [
      "Startup that created a methodology for collecting data on MMA fights and providing analytics to coaches and athletes.",
      "Developed web application for data visualization and reporting.",
      "Responsible for Branding, layouts and designs for web, social media and main frontend development for internal analytics tool.",
      "Marketing material including presentations for prospects, website, social media and data infographic.",
    ],
    achievements: [
      "Embeded tool used by news websites and betting companies across the world.",
    ],
    skills: [
      "HTML 5",
      "CSS 3",
    ...
    companyUrl: "https://www.fightanalytics.cc/",
    logo: "/experience/fightanalytics-logo.jpeg",
  },
  {
    id: "zerohora",
    ...
    description: [
      "Planning and development of interactive infographics for a news website;",
      "Video intros for web series along with design patterns for vignettes and hotsites.",
    ],
    achievements: [
      "Handoffs and methodologies that improved the workflow between journalists, designers and developers.",
    ],
    skills: [
      "HTML 5",
      "CSS 3",
    ...
    companyUrl: "https://gauchazh.clicrbs.com.br/",
    logo: "/experience/zh.jpeg",
  },
];
